...
public class Main {
  ...
  public static void main(String[] args) {
    // add student randomly to students list
...
//
    ...
    // srot uses LessSubmissionHigherPriority hueristic to order elements in Collections
  ...
  private static List<Submission> getSubmissions(List<String> students) {
    ...
    for (int i = 0; i < MAX_SUBMISSIONS; i++) {
      // adding a random submission count to each student
