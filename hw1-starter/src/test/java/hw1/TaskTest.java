...
public class TaskTest {
  ...
  @Test
  @DisplayName("twoSum works for input {0, 1} and target 1")
  public void trivialSample_case4() {
    int[] input = new int[]{0, 1};
    int target = 1;
    int[] expected = new int[]{0, 1};
    int[] actual = twoSum(input, target);
  ...
  public void trivialSample_case5() {
  ...
  @Test
  @DisplayName("twoSum works for input {1, 2} and target 3")
  public void trivialSample_case6() {
    int[] input = new int[]{1, 2};
    int target = 3;
    int[] expected = new int[]{0, 1};
    int[] actual = twoSum(input, target);
  ...
  @Test
  @DisplayName("twoSum works for input {0, 1} and target 1")
  public void trivialSample_case7() {
    int[] input = new int[]{0, 1};
    int target = 1;
    int[] expected = new int[]{0, 1};
    int[] actual = twoSum(input, target);
  ...
  @Test
  @DisplayName("twoSum works for input {1, 1} and target 2")
  public void trivialSample_case8() {
